  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Teemme pääosin aurinkopaneelien myyntiä- ja asennuksia."
        />
        ...
        <meta
          ...
          content="Palveluihimme kuuluu pääosin aurinkopaneelien myyntiä- ja asennuksia."
        />
        <meta
          name="keywords"
          content="Vihergia, vihergia, Vihergia Oy, vihreä, energia, green, energy, Uusimaa, Helsinki, Lahti, Aurinkopaneelit, aurinkopaneeli,
        ...
        <meta
          property="og:image"
          content="https://vihergia.fi/vihergia-etusivu-kuva.png"
        />
